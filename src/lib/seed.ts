...
export async function runSeed() {
  ...
  const enquiries = [
    { id: 'lead-1', fullName: 'Farai Moyo', companyName: 'MiningCo Ltd', phone: '+263771112222', email: 'farai@miningco.co.zw', enquiryType: 'quotation_request', serviceId: 'drilling', persona: 'mine_operator', leadTier: 'hot', status: 'new', priority: 'high', source: 'website', leadScore: 87, budgetRange: '$10K-$50K', timeline: 'Immediate', projectLocation: 'Mazowe', projectDescription: 'Need 2 boreholes for water supply at Mazowe mine. Depth approx 80m each. Solar pump required.', notes: 'Documents uploaded — site survey and water quality requirements.' },
    { id: 'lead-2', fullName: 'Tendai Dube', companyName: 'Bulawayo Drillers', phone: '+263773334444', email: 'tendai@bdrillers.co.zw', enquiryType: 'consultation_booking', serviceId: 'exploration', persona: 'investor', leadTier: 'warm', status: 'contacted', priority: 'medium', source: 'referral', leadScore: 60, budgetRange: '$50K-$200K', timeline: '1-3 months', projectLocation: 'Midlands', projectDescription: 'Exploration survey for new chrome claim in Midlands. 50 hectare property.', notes: 'Site visit scheduled for Friday.' },
    { id: 'lead-3', fullName: 'Simba Ncube', companyName: 'Ncube Holdings', phone: '+263775556666', email: 'simba@nholdings.co.zw', enquiryType: 'project_brief', serviceId: 'fabrication', persona: 'mine_operator', leadTier: 'hot', status: 'qualified', priority: 'urgent', source: 'direct', leadScore: 92, budgetRange: '$200K-$500K', timeline: 'Immediate', projectLocation: 'Trojan Mine', projectDescription: '10T headgear fabrication for Trojan Mine. Urgent — existing structure failed inspection.', notes: 'Engineering drawings provided. Needs fast-track delivery.' },
    { id: 'lead-4', fullName: 'Rutendo Chikosi', companyName: 'Gold Fields ZW', phone: '+263777778888', email: 'rutendo@gfields.co.zw', enquiryType: 'quotation_request', serviceId: 'project_management', persona: 'mine_operator', leadTier: 'hot', status: 'proposal_sent', priority: 'high', source: 'google', leadScore: 75, budgetRange: '$200K-$500K', timeline: '3-6 months', projectLocation: 'Kadoma', projectDescription: 'Project management for new gold mine development in Kadoma area.', notes: 'Proposal sent. Awaiting board review.' },
    { id: 'lead-5', fullName: 'Tafadzwa Zhou', companyName: 'Zhou Mining', phone: '+263779990000', email: 'tf@zhoumining.co.zw', enquiryType: 'training_enrollment', serviceId: 'training', persona: 'training', leadTier: 'warm', status: 'negotiating', priority: 'medium', source: 'facebook', leadScore: 55, budgetRange: '<$10K', timeline: '1-3 months', projectLocation: 'Harare', projectDescription: '5 team members need Mine Blasting Certification.', notes: 'Price discussion ongoing. Batch Q3 2026 preferred.' },
    { id: 'lead-6', fullName: 'Chipo Moyo', companyName: 'Mazowe Resources', phone: '+263778881111', email: 'chipo@mazoweres.co.zw', enquiryType: 'quotation_request', serviceId: 'project_management', persona: 'mine_operator', leadTier: 'hot', status: 'won', priority: 'medium', source: 'referral', leadScore: 82, budgetRange: '$50K-$200K', timeline: 'Immediate', projectLocation: 'Mazowe', notes: 'Closed. Shaft rehab project started. $24,500 budget approved.' },
    { id: 'lead-7', fullName: 'Blessing Dube', companyName: 'Mutare Miners', phone: '+263774445555', email: 'blessing@mutaremines.co.zw', enquiryType: 'general_inquiry', serviceId: 'drilling', persona: 'general', leadTier: 'cold', status: 'lost', priority: 'low', source: 'website', leadScore: 25, projectLocation: 'Mutare', notes: 'Chose competitor. Price-sensitive.' },
    { id: 'lead-8', fullName: 'Patience Ndlovu', companyName: 'Gwanda Gold', phone: '+263772223333', email: 'patience@gwandagold.co.zw', enquiryType: 'quotation_request', serviceId: 'exploration', persona: 'investor', leadTier: 'hot', status: 'new', priority: 'high', source: 'google', leadScore: 78, budgetRange: '$10K-$50K', timeline: '3-6 months', projectLocation: 'Gwanda', projectDescription: 'Exploration survey for new claim in Gwanda. Gold target.', notes: 'Claims documentation verified.' },
    { id: 'lead-9', fullName: 'John Mhangami (UK)', companyName: 'Diaspora Gold Ltd', phone: '+447700123456', email: 'john@diasporagold.co.uk', enquiryType: 'site_assessment', serviceId: 'consultancy', persona: 'investor', leadTier: 'hot', status: 'new', priority: 'high', source: 'website', leadScore: 85, budgetRange: '$200K-$500K', timeline: '1-3 months', projectLocation: 'Shurugwi', projectDescription: 'UK-based investor looking to fund gold exploration in Shurugwi. Needs site assessment, valuation, and investment report.', notes: 'Diaspora lead — prefers WhatsApp communication.' },
    { id: 'lead-10', fullName: 'Sarah Ndlovu (SA)', companyName: 'SA-Zim Mining Partners', phone: '+27711234567', email: 'sarah@sazim.co.za', enquiryType: 'investor_info', serviceId: 'borehole', persona: 'investor', leadTier: 'warm', status: 'contacted', priority: 'medium', source: 'referral', leadScore: 65, budgetRange: '$50K-$200K', timeline: '3-6 months', projectLocation: 'Bulawayo', projectDescription: 'South Africa-based Zimbabwean looking to fund borehole drilling for community water project and small-scale mining.', notes: 'Interested in diaspora investor portal access.' },
  ];
