...
const services = [
  ...
  { icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2', title: 'Project Mgmt', desc: 'End-to-end mining project management, scheduling, budgeting, and contractor oversight.' },
];
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-36">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mt-2">
              Strength Above<br />
              <span className="text-primary-400">Ground</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link to="/roi-calculator">
                <Button variant="accent" size="lg">Calculate Your ROI &#8594;</Button>
              </Link>
              <Link to="/lead-form">
          ...
          <div className="max-w-2xl mx-auto">
            <Card padding="lg" className="text-center bg-gradient-to-br from-primary-50 to-white border border-primary-100">
              ...
              <p className="text-gray-600 mt-2 text-sm">
                Input your property size, target mineral, and budget — we'll recommend the optimal exploration package with expected yield and payback timeline.
              </p>
              <Link to="/roi-calculator" className="inline-block mt-6">
                <Button variant="accent" size="lg">Start Calculating &#8594;</Button>
              </Link>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {projectShowcase.map((p) => (
              <Card key={p.title} padding="none">
                ...
                <div className="p-4">
                  ...
                  <span className="text-sm text-primary-500 font-medium">{p.status}</span>
                </div>
              </Card>
            ))}
          </div>
          <div className="text-center mt-8">
            <Link to="/client-dashboard">
              <Button variant="primary">View Project Command Center</Button>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-secondary text-white">
        <div className="max-w-3xl mx-auto text-center px-4">
          ...
          <p className="mt-4 text-gray-300 text-lg">
            Get an exploration ROI estimate, book a consultation, or enroll your team in certified training — all in one place.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link to="/roi-calculator">
              <Button variant="accent" size="lg">Calculate ROI</Button>
            </Link>
            <Link to="/lead-form">
              <Button variant="outline" size="lg" className="border-white text-white hover:bg-white/10">
                Get Quote
